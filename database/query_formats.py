...
# 유저 기본 정보 초기화
signup_primary_data_insert_format = "INSERT INTO account(id, password, registration_key, name, age, type, gender, phone_number) VALUES('%s', '%s', '%s', '%s', %d, %d, '%s', '%s')"
...
get_person_contribution_format = "SELECT * FROM user_contribution WHERE id='%s'"
