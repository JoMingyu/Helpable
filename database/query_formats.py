...
person_contribution_initialize_format = "INSERT INTO person_contribution(id, give, take) VALUES('%s', 0, 0)"
...
get_person_contribution_format = "SELECT * FROM person_contribution WHERE id='%s'"
